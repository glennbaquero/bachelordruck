...
use Support\Middleware\BackendLanguageMiddleware;
use Support\Middleware\EncryptCookies;
use Support\Middleware\FrontendLanguageMiddleware;
...
class HttpKernel extends Kernel
{
    ...
    protected $routeMiddleware = [
        ...
        'backend.language' => BackendLanguageMiddleware::class,
        'frontend.language' => FrontendLanguageMiddleware::class,
    ];
}
